...
wbool w_toolkit_custom_get_high_contrast(w_toolkit *toolkit) {
	w_toolkit *systoolkit = ((struct c_toolkit*) toolkit)->system_toolkit;
...
wbool w_toolkit_custom_get_touch_enabled(w_toolkit *toolkit) {
	w_toolkit *systoolkit = ((struct c_toolkit*) toolkit)->system_toolkit;
...
wbool w_toolkit_custom_post(w_toolkit *toolkit, w_event *event) {
	w_toolkit *systoolkit = ((struct c_toolkit*) toolkit)->system_toolkit;
	return W_TOOLKIT_GET_CLASS(systoolkit)->post(systoolkit,event);
}
wbool w_toolkit_custom_post_quit(w_toolkit *toolkit, int quit) {
	w_toolkit *systoolkit = ((struct c_toolkit*) toolkit)->system_toolkit;
	return W_TOOLKIT_GET_CLASS(systoolkit)->post_quit(systoolkit,quit);
}
wbool w_toolkit_custom_read_and_dispatch(w_toolkit *toolkit) {
	w_toolkit *systoolkit = ((struct c_toolkit*) toolkit)->system_toolkit;
...
wbool w_toolkit_custom_sleep(w_toolkit *toolkit) {
	w_toolkit *systoolkit = ((struct c_toolkit*) toolkit)->system_toolkit;
...
wbool w_toolkit_custom_dialog_file_open(w_toolkit *toolkit,
