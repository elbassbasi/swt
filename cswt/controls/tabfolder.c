...
wbool wc_tabfolder_update_tab_height(w_tabfolder *tabfolder, w_graphics *gc,
		wbool force) {
...
wbool wc_tabfolder_set_item_size(w_tabfolder *tabfolder, w_graphics *gc) {
	struct wc_tabfolder_priv *priv = wc_control_get_priv(W_CONTROL(tabfolder));
	wc_tabitem *tab;
	wbool changed = W_FALSE;
	//if (IsDisposed())
	//	return changed;
	w_rect bounds;
	w_size result;
...
wbool wc_tabfolder_set_item_location(w_tabfolder *tabfolder, w_graphics *gc) {
	struct wc_tabfolder_priv *priv = wc_control_get_priv(W_CONTROL(tabfolder));
	wc_tabitem *item;
...
wbool wc_tabfolder_update_items(w_tabfolder *tabfolder, w_graphics *gc,
		wc_tabitem *showItem) {
	struct wc_tabfolder_priv *priv = wc_control_get_priv(W_CONTROL(tabfolder));
	...
	wbool oldShowChevron = priv->showChevron;
	wbool changed = wc_tabfolder_set_item_size(tabfolder, gc);
 ...
 *
 */
wbool wc_tabitem_is_ok(w_widgetdata *obj) {
	return W_TRUE;
}
...
wbool wc_tabitem_equals(w_widgetdata *obj1, w_widgetdata *obj2) {
