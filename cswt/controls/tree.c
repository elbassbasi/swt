 ...
 * tree column
 */
wbool wc_treecolumn_is_ok(w_widgetdata *obj){}
void wc_treecolumn_close(w_widgetdata *obj){}
void wc_treecolumn_copy(w_widgetdata *from, w_widgetdata *to){}
wbool wc_treecolumn_equals(w_widgetdata *obj1, w_widgetdata *obj2){}
...
wbool wc_treecolumn_get_moveable(w_treecolumn *column){}
int wc_treecolumn_get_order(w_treecolumn *column){}
wbool wc_treecolumn_get_resizable(w_treecolumn *column){}
...
wresult wc_treecolumn_set_moveable(w_treecolumn *column, wbool moveable){}
wresult wc_treecolumn_set_order(w_treecolumn *column, int order){}
wresult wc_treecolumn_set_resizable(w_treecolumn *column, wbool resizable){}
 ...
 * tree item
 */
wbool wc_treeitem_is_ok(w_widgetdata *obj){}
void wc_treeitem_close(w_widgetdata *obj){}
void wc_treeitem_copy(w_widgetdata *from, w_widgetdata *to){}
wbool wc_treeitem_equals(w_widgetdata *obj1, w_widgetdata *obj2){}
...
wresult wc_treeitem_clear(w_treeitem *item, int index, wbool all){}
wresult wc_treeitem_clear_all(w_treeitem *item, wbool all){}
void wc_treeitem_get_bounds(w_treeitem *item, w_rect *bounds){}
wbool wc_treeitem_get_checked(w_treeitem *item){}
wbool wc_treeitem_get_expanded(w_treeitem *item){}
wbool wc_treeitem_get_first_child(w_treeitem *item, w_treeitem *child){}
wbool wc_treeitem_get_grayed(w_treeitem *item){}
wbool wc_treeitem_get_item(w_treeitem *item, int index, w_treeitem *subitem){}
...
wbool wc_treeitem_get_last_child(w_treeitem *item, w_treeitem *child){}
wbool wc_treeitem_get_next_sibling(w_treeitem *item, w_treeitem *next){}
wbool wc_treeitem_get_parent_item(w_treeitem *item, w_treeitem *parent){}
wbool wc_treeitem_get_prev_sibling(w_treeitem *item, w_treeitem *prev){}
...
wresult wc_treeitem_set_checked(w_treeitem *item, wbool checked){}
wresult wc_treeitem_set_expanded(w_treeitem *item, wbool expanded){}
wresult wc_treeitem_set_grayed(w_treeitem *item, wbool grayed){}
...
wbool wc_tree_get_header_visible(w_tree *tree){}
wbool wc_tree_get_column(w_tree *tree, int index, w_treecolumn *column){}
...
wbool wc_tree_get_item(w_tree *tree, w_point *point, w_treeitem *item){}
int wc_tree_get_item_height(w_tree *tree){}
wbool wc_tree_get_lines_visible(w_tree *tree){}
wbool wc_tree_get_parent_item(w_tree *tree, w_treeitem *item){}
wbool wc_tree_get_root_item(w_tree *tree, w_treeitem *root){}
void wc_tree_get_selection(w_tree *tree, w_iterator *selection){}
int wc_tree_get_selection_count(w_tree *tree){}
wbool wc_tree_get_sort_column(w_tree *tree, w_treecolumn *column){}
int wc_tree_get_sort_direction(w_tree *tree){}
wbool wc_tree_get_top_item(w_tree *tree, w_treeitem *topitem){}
...
wresult wc_tree_set_insert_mark(w_tree *tree, w_treeitem *item, wbool before){}
wresult wc_tree_set_item_height(w_tree *tree, int itemHeight){}
wresult wc_tree_set_lines_visible(w_tree *tree, wbool show){}
wresult wc_tree_select(w_tree *tree, w_treeitem *item){}
wresult wc_tree_select_all(w_tree *tree){}
wresult wc_tree_set_header_visible(w_tree *tree, wbool show){}
