...
#ifndef SRC_CUSTOM_THEMES_METAL_H_
#define SRC_CUSTOM_THEMES_METAL_H_
...
void w_theme_metal_draw_gradient(w_theme *theme, w_graphics *gc, w_rect *rect,wbool vertical );
...
#endif /* SRC_CUSTOM_THEMES_METAL_H_ */
