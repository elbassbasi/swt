...
wbool w_toolbar_get_item(w_toolbar *toolbar, int index, w_toolitem *item) {
	wresult result = W_WIDGET_CHECK0(toolbar);
	if (result > 0) {
...
wbool w_toolbar_get_item_from_point(w_toolbar *toolbar, w_point *point,
		w_toolitem *item) {
	wresult result = W_WIDGET_CHECK0(toolbar);
	if (result > 0) {
...
wbool w_toolitem_get_enabled(w_toolitem *item) {
	wresult result = W_WIDGETDATA_CHECK0(item);
	if (result > 0) {
...
wbool w_toolitem_get_selection(w_toolitem *item) {
	wresult result = W_WIDGETDATA_CHECK0(item);
	if (result > 0) {
...
wbool w_toolitem_is_enabled(w_toolitem *item) {
	wresult result = W_WIDGETDATA_CHECK0(item);
	if (result > 0) {
...
wresult w_toolitem_set_enabled(w_toolitem *item, wbool enabled) {
	wresult result = W_WIDGETDATA_CHECK0(item);
	if (result > 0) {
...
wresult w_toolitem_set_selection(w_toolitem *item, wbool selected) {
	wresult result = W_WIDGETDATA_CHECK0(item);
	if (result > 0) {
