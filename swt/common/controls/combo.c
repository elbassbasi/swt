...
wbool w_combo_get_list_visible(w_combo *combo) {
	wresult result = W_WIDGET_CHECK0(combo);
	if (result > 0) {
...
wresult w_combo_set_list_visible(w_combo *combo, wbool visible) {
	wresult result = W_WIDGET_CHECK0(combo);
	if (result > 0) {
...
wbool w_combo_get_selection(w_combo *combo, w_point *pt) {
	wresult result = W_WIDGET_CHECK0(combo);
	if (result > 0) {
