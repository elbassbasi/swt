...
w_toolkit* w_toolkit_get_default() {
	if (w_toolkit_default == 0) {
		return w_toolkit_get_platform();
	} else {
		return w_toolkit_default;
	}
}
wresult w_toolkit_set_default(w_toolkit *toolkit) {
	if (toolkit != 0 && toolkit->disposable.clazz == 0) {
		return W_ERROR_INVALID_ARGUMENT;
	}
	w_toolkit_default = toolkit;
	return W_TRUE;
}
...
wresult w_toolkit_close(w_toolkit *toolkit) {
	if (toolkit == 0)
		toolkit = w_toolkit_get_default();
	return W_TOOLKIT_GET_CLASS(toolkit)->close(toolkit);
}
...
wbool w_toolkit_get_high_contrast(w_toolkit *toolkit) {
	if (toolkit == 0)
		toolkit = w_toolkit_get_default();
...
wbool w_toolkit_get_touch_enabled(w_toolkit *toolkit) {
	if (toolkit == 0)
		toolkit = w_toolkit_get_default();
...
wbool w_toolkit_post(w_toolkit *toolkit, w_event *event) {
	if (toolkit == 0)
		toolkit = w_toolkit_get_default();
	return W_TOOLKIT_GET_CLASS(toolkit)->post(toolkit, event);
}
wbool w_toolkit_post_quit(w_toolkit *toolkit, int quit) {
	if (toolkit == 0)
		toolkit = w_toolkit_get_default();
	return W_TOOLKIT_GET_CLASS(toolkit)->post_quit(toolkit, quit);
}
wbool w_toolkit_read_and_dispatch(w_toolkit *toolkit) {
	if (toolkit == 0)
		toolkit = w_toolkit_get_default();
	return W_TOOLKIT_GET_CLASS(toolkit)->read_and_dispatch(toolkit);
}
...
wbool w_toolkit_sleep(w_toolkit *toolkit) {
	if (toolkit == 0)
		toolkit = w_toolkit_get_default();
	return W_TOOLKIT_GET_CLASS(toolkit)->sleep(toolkit);
}
...
void* w_toolkit_malloc(w_toolkit *toolkit, size_t size) {
	if (toolkit == 0)
		toolkit = w_toolkit_get_default();
	return W_TOOLKIT_GET_CLASS(toolkit)->malloc(toolkit, size);
}
void* w_toolkit_realloc(w_toolkit *toolkit, void *ptr, size_t size) {
	if (toolkit == 0)
		toolkit = w_toolkit_get_default();
	return W_TOOLKIT_GET_CLASS(toolkit)->realloc(toolkit, ptr, size);
}
void w_toolkit_free(w_toolkit *toolkit, void *ptr) {
	if (toolkit == 0)
		toolkit = w_toolkit_get_default();
	W_TOOLKIT_GET_CLASS(toolkit)->free(toolkit, ptr);
}
/*
 *
 */
