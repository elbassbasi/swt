...
wbool w_iterator_next(w_iterator *it, void *obj) {
...
wbool _w_iterator_next(w_iterator *it, void *obj) {
	return W_FALSE;
}
 ...
 *
 */
wbool w_iterator_array_filter_default(void *userdata, void *obj) {
	return W_TRUE;
}
wresult _w_iterator_array_close(w_iterator *it) {
	return W_TRUE;
}
wbool _w_iterator_array_next(w_iterator *it, void *obj) {
...
wbool w_iterator_array_create(w_iterator *it, void *array, size_t length,
