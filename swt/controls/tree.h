...
struct _w_treecolumn_class {
	...
	wresult (*get_moveable)(w_treecolumn *column);
	int (*get_order)(w_treecolumn *column);
	wresult (*get_resizable)(w_treecolumn *column);
	...
	wresult (*set_moveable)(w_treecolumn *column, int moveable);
	wresult (*set_order)(w_treecolumn *column, int order);
	wresult (*set_resizable)(w_treecolumn *column, int resizable);
...
struct _w_tree_class {
	...
	wresult (*get_header_visible)(w_tree *tree);
	wresult (*get_column)(w_tree *tree, int index, w_treecolumn *column);
	int (*get_column_count)(w_tree *tree);
	void (*get_columns)(w_tree *tree, w_iterator *columns);
	w_imagelist* (*get_imagelist)(w_tree *tree);
	wresult (*get_item)(w_tree *tree, w_point *point, w_treeitem *item);
	int (*get_item_height)(w_tree *tree);
	wresult (*get_lines_visible)(w_tree *tree);
	wresult (*get_parent_item)(w_tree *tree, w_treeitem *item);
	wresult (*get_root_item)(w_tree *tree, w_treeitem *root);
	void (*get_selection)(w_tree *tree, w_iterator *selection);
	int (*get_selection_count)(w_tree *tree);
	wresult (*get_sort_column)(w_tree *tree, w_treecolumn *column);
	int (*get_sort_direction)(w_tree *tree);
	wresult (*get_top_item)(w_tree *tree, w_treeitem *topitem);
	...
	wresult (*set_insert_mark)(w_tree *tree, w_treeitem *item, int before);
	wresult (*set_item_height)(w_tree *tree, int itemHeight);
	wresult (*set_lines_visible)(w_tree *tree, int show);
	wresult (*select)(w_tree *tree, w_treeitem *item);
	wresult (*select_all)(w_tree *tree);
	wresult (*set_header_visible)(w_tree *tree, int show);
...
SWT_PUBLIC wresult w_treecolumn_get_moveable(w_treecolumn *column);
SWT_PUBLIC int w_treecolumn_get_order(w_treecolumn *column);
SWT_PUBLIC wresult w_treecolumn_get_resizable(w_treecolumn *column);
...
SWT_PUBLIC wresult w_tree_get_header_visible(w_tree *tree);
SWT_PUBLIC wresult w_tree_get_column(w_tree *tree, int index,
		w_treecolumn *column);
...
SWT_PUBLIC wresult w_tree_get_item(w_tree *tree, w_point *point,
		w_treeitem *item);
SWT_PUBLIC int w_tree_get_item_height(w_tree *tree);
SWT_PUBLIC wresult w_tree_get_lines_visible(w_tree *tree);
SWT_PUBLIC wresult w_tree_get_parent_item(w_tree *tree, w_treeitem *item);
SWT_PUBLIC wresult w_tree_get_root_item(w_tree *tree, w_treeitem *root);
...
SWT_PUBLIC wresult w_tree_get_sort_column(w_tree *tree, w_treecolumn *column);
SWT_PUBLIC int w_tree_get_sort_direction(w_tree *tree);
SWT_PUBLIC wresult w_tree_get_top_item(w_tree *tree, w_treeitem *topitem);
...
SWT_PUBLIC wresult w_tree_set_lines_visible(w_tree *tree, int show);
SWT_PUBLIC wresult w_tree_select(w_tree *tree, w_treeitem *item);
SWT_PUBLIC wresult w_tree_select_all(w_tree *tree);
SWT_PUBLIC wresult w_tree_set_header_visible(w_tree *tree, int show);
