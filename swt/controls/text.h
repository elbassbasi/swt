...
struct _w_text_class {
	...
	wresult (*set_doubleclick_enabled)(w_text *text, int doubleClick);
	wresult (*set_echochar)(w_text *text, int echo);
	wresult (*set_editable)(w_text *text, int editable);
...
SWT_PUBLIC wresult w_text_set_editable(w_text *text, int editable);
