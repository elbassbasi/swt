...
struct _w_combo_class {
	...
	wresult (*get_list_visible)(w_combo *combo);
	wresult (*set_list_visible)(w_combo *combo, int visible);
	wresult (*get_selection)(w_combo *combo, w_point *pt);
...
SWT_PUBLIC wresult w_combo_get_list_visible(w_combo *combo);
SWT_PUBLIC wresult w_combo_set_list_visible(w_combo *combo, int visible);
SWT_PUBLIC wresult w_combo_get_selection(w_combo *combo, w_point *pt);
