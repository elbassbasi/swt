...
#ifndef SWT_CONTROLS_SLIDER_H_
#define SWT_CONTROLS_SLIDER_H_
...
struct _w_slider_class {
	...
	int (*get_increment)(w_slider *slider);
	int (*get_maximum)(w_slider *slider);
	int (*get_minimum)(w_slider *slider);
	int (*get_page_increment)(w_slider *slider);
	int (*get_selection)(w_slider *slider);
	int (*get_thumb)(w_slider *slider);
...
SWT_PUBLIC int w_slider_get_increment(w_slider *slider);
SWT_PUBLIC int w_slider_get_maximum(w_slider *slider);
SWT_PUBLIC int w_slider_get_minimum(w_slider *slider);
SWT_PUBLIC int w_slider_get_page_increment(w_slider *slider);
SWT_PUBLIC int w_slider_get_selection(w_slider *slider);
SWT_PUBLIC int w_slider_get_thumb(w_slider *slider);
