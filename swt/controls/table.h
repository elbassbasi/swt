...
struct _w_tablecolumn_class {
	...
	wresult (*get_moveable)(w_tablecolumn *column);
	wresult (*get_resizable)(w_tablecolumn *column);
	...
	wresult (*set_moveable)(w_tablecolumn *column, int moveable);
	wresult (*set_resizable)(w_tablecolumn *column, int resizable);
...
struct _w_tableitem_class {
	...
	wresult (*get_checked)(w_tableitem *item);
	int (*get_image)(w_tableitem *item);
	wresult (*set_checked)(w_tableitem *item, int checked);
...
struct _w_table_class {
	...
	wresult (*get_header_visible)(w_table *table);
	w_imagelist* (*get_imagelist)(w_table *table);
	wresult (*get_item)(w_table *table, int index, w_tableitem *item);
	wresult (*get_item_from_point)(w_table *table, w_point *point,
			w_tableitem *item);
	int (*get_item_count)(w_table *table);
	int (*get_item_height)(w_table *table);
	void (*get_items)(w_table *table, w_iterator *items);
	wresult (*get_lines_visible)(w_table *table);
	...
	size_t (*get_selection_indices)(w_table *table, int *indeics,
			size_t length);
	wresult (*get_sort_column)(w_table *table, w_tablecolumn *column);
	int (*get_sort_direction)(w_table *table);
	int (*get_top_index)(w_table *table);
	wresult (*is_selected)(w_table *table, int index);
	...
	wresult (*set_header_visible)(w_table *table, int show);
	wresult (*set_imagelist)(w_table* table,w_imagelist* imagelist);
	wresult (*set_lines_visible)(w_table *table, int show);
...
SWT_PUBLIC wresult w_tablecolumn_get_moveable(w_tablecolumn *column);
SWT_PUBLIC wresult w_tablecolumn_get_resizable(w_tablecolumn *column);
...
SWT_PUBLIC wresult w_tableitem_get_bounds_index(w_tableitem *item, int index,
		w_rect *bounds);
SWT_PUBLIC wresult w_tableitem_get_checked(w_tableitem *item);
SWT_PUBLIC int w_tableitem_get_image(w_tableitem *item);
SWT_PUBLIC wresult w_tableitem_set_checked(w_tableitem *item, int checked);
...
SWT_PUBLIC wresult w_table_get_header_visible(w_table *table);
SWT_PUBLIC w_imagelist* w_table_get_imagelist(w_table *table);
SWT_PUBLIC wresult w_table_get_item(w_table *table, int index,
		w_tableitem *item);
SWT_PUBLIC wresult w_table_get_item_from_point(w_table *table, w_point *point,
		w_tableitem *item);
...
SWT_PUBLIC wresult w_table_get_lines_visible(w_table *table);
...
SWT_PUBLIC size_t w_table_get_selection_indices(w_table *table, int *indeics,
		size_t length);
SWT_PUBLIC wresult w_table_get_sort_column(w_table *table,
		w_tablecolumn *column);
SWT_PUBLIC int w_table_get_sort_direction(w_table *table);
SWT_PUBLIC int w_table_get_top_index(w_table *table);
SWT_PUBLIC wresult w_table_is_selected(w_table *table, int index);
...
SWT_PUBLIC wresult w_table_set_column_order(w_table *table, int *order,
		size_t length);
SWT_PUBLIC wresult w_table_set_header_visible(w_table *table, int show);
SWT_PUBLIC wresult w_table_set_imagelist(w_table* table,w_imagelist* imagelist);
SWT_PUBLIC wresult w_table_set_lines_visible(w_table *table, int show);
