...
public:
	 ...
	 */
	void DrawFocus(WRect &rect) {
		w_graphics_draw_focus(W_GRAPHICS(this), (w_rect*) &rect);
	}
	/**
	 * Draws a rectangle, based on the specified arguments, which has
	 * the appearance of the platform's <em>focus rectangle</em> if the
	 ...
	 */
	w_line_dash* GetLineDash() {
		return w_graphics_get_line_dash(W_GRAPHICS(this));
	}
	/**
	 ...
	 * @see #setAdvanced
	 */
	void SetTransform(WTransform *transform) {
