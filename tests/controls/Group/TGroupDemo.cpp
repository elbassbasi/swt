...
void TGroupDemo::Registre(WTreeItem &parent) {
	ITreeItem::Regitre(parent, "Demonstrates", new TGroupDemo());
}
const char *TGroupDemo::RADIO_TEXTS[] = { "John", "Paul", "George", "Ringo",
		"Barry", "Robin", "Maurice" };
void TGroupDemo::CreateControl(WComposite *parent) {
