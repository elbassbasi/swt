...
#ifndef SWT_CORE_VALUE_H_
#define SWT_CORE_VALUE_H_
#include "string.h"
#ifdef __cplusplus
extern "C" {
#endif
...
SWT_PUBLIC void w_value_init_int64(w_value *value, wint64 _int64);
...
SWT_PUBLIC wbool w_value_init_string(w_value *value, const char *string,
...
SWT_PUBLIC wbool w_value_set_string(w_value *value, const char *string,
		size_t length, int flags);
