...
typedef struct _w_iterator_class {
	...
	wbool (*next)(w_iterator *it, void *obj);
...
SWT_PUBLIC wbool w_iterator_next(w_iterator *it, void *obj);
...
typedef wbool (*w_iterator_array_filter)(void *userdata, void *obj);
...
SWT_PUBLIC wbool w_iterator_array_create(w_iterator *it, void *array,
