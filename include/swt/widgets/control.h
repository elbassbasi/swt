...
struct _w_control_class {
	...
	wresult (*pack)(w_control *control, wbool changed);
	...
	wresult (*set_tab)(w_control *control, wbool tab);
...
SWT_PUBLIC wresult w_control_compute_size_0(w_control *control, w_size *size,
		int wHint, int hHint, wbool changed);
...
SWT_PUBLIC wresult w_control_move_below(w_control *control,
		w_control *_control);
SWT_PUBLIC wresult w_control_pack(w_control *control, wbool changed);
...
SWT_PUBLIC wresult w_control_set_tab(w_control *control, wbool tab);
