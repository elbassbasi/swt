...
struct _w_menuitem_class {
	...
	wbool (*get_enabled)(w_menuitem *item);
	...
	wbool (*get_parent)(w_menuitem *item, w_menuitem *parent);
	wbool (*get_selection)(w_menuitem *item);
	int (*get_style)(w_menuitem *item);
	wbool (*is_enabled)(w_menuitem *item);
	...
	wresult (*set_enabled)(w_menuitem *item, wbool enabled);
	wresult (*set_id)(w_menuitem *item, wushort id);
	wresult (*set_image)(w_menuitem *item, w_image *image);
	wresult (*set_selection)(w_menuitem *item, wbool selected);
};
struct _w_menu_class {
	...
	wbool (*get_visible)(w_menu *menu);
	wbool (*is_visible)(w_menu *menu);
	void (*set_location)(w_menu *menu, w_point *location);
	void (*set_orientation)(w_menu *menu, int orientation);
	wresult (*set_visible)(w_menu *menu, wbool visible);
};
/*
 * menuitem
 */
...
SWT_PUBLIC wbool w_menuitem_get_enabled(w_menuitem *item);
...
SWT_PUBLIC wbool w_menuitem_get_parent(w_menuitem *item, w_menuitem *parent);
SWT_PUBLIC wbool w_menuitem_get_selection(w_menuitem *item);
SWT_PUBLIC int w_menuitem_get_style(w_menuitem *item);
SWT_PUBLIC wbool w_menuitem_is_enabled(w_menuitem *item);
...
SWT_PUBLIC wresult w_menuitem_set_enabled(w_menuitem *item, wbool enabled);
...
SWT_PUBLIC wresult w_menuitem_set_selection(w_menuitem *item, wbool selected);
/*
 * menu
 */
...
SWT_PUBLIC wbool w_menu_get_visible(w_menu *menu);
SWT_PUBLIC wbool w_menu_is_visible(w_menu *menu);
...
SWT_PUBLIC wresult w_menu_set_visible(w_menu *menu, wbool visible);
