...
struct _w_caret_class {
	...
	wresult (*set_visible)(w_caret *caret, wbool visible);
};
...
SWT_PUBLIC wresult w_caret_set_visible(w_caret *caret, wbool visible);
...
struct _w_canvas_class {
	...
	wresult (*scroll)(w_canvas *canvas, w_point *dest, w_rect *rect, wbool all);
