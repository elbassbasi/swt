...
struct _w_toolkit_class {
    ...
    void* (*malloc)(w_toolkit *toolkit,size_t size);
    void* (*realloc)(w_toolkit *toolkit,void *ptr, size_t size);
    void (*free)(w_toolkit *toolkit,void* ptr);
	...
	wresult (*close)(w_toolkit *toolkit);
	...
	wbool (*get_high_contrast)(w_toolkit *toolkit);
	...
	wbool (*get_touch_enabled)(w_toolkit *toolkit);
	...
	wbool (*post)(w_toolkit *toolkit, w_event *event);
	wbool (*post_quit)(w_toolkit *toolkit,int quit);
	wbool (*read_and_dispatch)(w_toolkit *toolkit);
	 ...
	 * dialogs
	 */
	int (*messagebox_open)(w_toolkit *toolkit, w_messagebox *messagebox);
	wbool (*dialog_color_open)(w_toolkit *toolkit,
			w_dialog_color *dialog_color);
	wbool (*dialog_font_open)(w_toolkit *toolkit, w_dialog_font *dialog_font);
	wbool (*dialog_directory_open)(w_toolkit *toolkit,
			w_dialog_directory *dialog_directory);
	wbool (*dialog_file_open)(w_toolkit *toolkit, w_dialog_file *dialog_file);
};
#define W_TOOLKIT_CLASS(x) ((struct _w_toolkit_class*)x)
#define W_TOOLKIT_GET_CLASS(x) W_TOOLKIT_CLASS(((w_disposable*)x)->clazz)

SWT_PUBLIC w_toolkit* w_toolkit_get_platform();
SWT_PUBLIC w_toolkit* w_toolkit_get_default();
SWT_PUBLIC wresult w_toolkit_set_default(w_toolkit *toolkit);
...
SWT_PUBLIC wresult w_toolkit_close(w_toolkit *toolkit);
...
SWT_PUBLIC wbool w_toolkit_get_high_contrast(w_toolkit *toolkit);
...
SWT_PUBLIC wbool w_toolkit_get_touch_enabled(w_toolkit *toolkit);
...
SWT_PUBLIC wresult w_toolkit_map_1(w_toolkit *toolkit, w_control *from, w_control *to,
		w_rect *result, w_rect *rectangle);
SWT_PUBLIC wbool w_toolkit_post(w_toolkit *toolkit, w_event *event);
SWT_PUBLIC wbool w_toolkit_post_quit(w_toolkit *toolkit,int quit);
SWT_PUBLIC wbool w_toolkit_read_and_dispatch(w_toolkit *toolkit);
...
SWT_PUBLIC wbool w_toolkit_sleep(w_toolkit *toolkit);
...
SWT_PUBLIC void* w_toolkit_malloc(w_toolkit *toolkit,size_t size);
SWT_PUBLIC void* w_toolkit_realloc(w_toolkit *toolkit,void *ptr, size_t size);
SWT_PUBLIC void w_toolkit_free(w_toolkit *toolkit,void* ptr);
