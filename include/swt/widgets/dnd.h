...
SWT_PUBLIC wbool w_clipboard_is_ok(w_clipboard *clipboard);
...
SWT_PUBLIC wresult w_dragsource_create(w_dragsource *dragsource,
		w_toolkit *toolkit, w_control *control, wuint64 style,
...
SWT_PUBLIC wresult w_droptarget_create(w_droptarget *droptarget,
		w_toolkit *toolkit, w_control *control, wuint64 style,
		w_widget_post_event_proc post_event);
...
SWT_PUBLIC wresult w_transfer_text_set_data(w_transfer *transfer,
		w_transfer_data *transferData, const void *data, size_t size);
SWT_PUBLIC extern w_transfer w_transfer_text;
/*
 * FileTransfer
 */
...
SWT_PUBLIC wresult w_transfer_file_set_data(w_transfer *transfer,
		w_transfer_data *transferData, const void *data, size_t size);
SWT_PUBLIC extern w_transfer w_transfer_file;
/*
 * HTMLTransfer
 */
...
SWT_PUBLIC wresult w_transfer_html_set_data(w_transfer *transfer,
		w_transfer_data *transferData, const void *data, size_t size);
SWT_PUBLIC extern w_transfer w_transfer_html;
/*
 * ImageTransfer
 */
...
SWT_PUBLIC wresult w_transfer_image_set_data(w_transfer *transfer,
		w_transfer_data *transferData, const void *data, size_t size);
SWT_PUBLIC extern w_transfer w_transfer_image;
/*
 * RTFTransfer
 */
...
SWT_PUBLIC wresult w_transfer_rtf_set_data(w_transfer *transfer,
		w_transfer_data *transferData, const void *data, size_t size);
SWT_PUBLIC extern w_transfer w_transfer_rtf;
/*
 * URLTransfer
 */
...
SWT_PUBLIC wresult w_transfer_url_set_data(w_transfer *transfer,
		w_transfer_data *transferData, const void *data, size_t size);
SWT_PUBLIC extern w_transfer w_transfer_url;
