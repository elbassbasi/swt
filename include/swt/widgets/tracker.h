...
struct _w_tracker_class {
	...
	void (*get_rectangles)(w_tracker *tracker, w_iterator* iterator);
	wbool (*get_stippled)(w_tracker *tracker);
	...
	wresult (*set_rectangles)(w_tracker *tracker, w_rect *rectangles,
			size_t length);
	wresult (*set_stippled)(w_tracker *tracker, wbool stippled);
};
...
SWT_PUBLIC void w_tracker_get_rectangles(w_tracker *tracker,w_iterator* iterator);
SWT_PUBLIC wbool w_tracker_get_stippled(w_tracker *tracker);
...
SWT_PUBLIC wresult w_tracker_set_rectangles(w_tracker *tracker, w_rect *rectangles,
		size_t length);
SWT_PUBLIC wresult w_tracker_set_stippled(w_tracker *tracker, wbool stippled);
