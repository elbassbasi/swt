...
SWT_PUBLIC wbool w_thread_equal(w_thread *thread1, w_thread *thread2);
SWT_PUBLIC wbool w_threadid_equal(w_threadid thread1, w_threadid thread2);
SWT_PUBLIC void w_thread_dispose(w_thread *thread);
SWT_PUBLIC wresult w_thread_create(w_thread *thread, w_thread_start start_proc,
...
SWT_PUBLIC wbool w_thread_is_current(w_thread *thread);
SWT_PUBLIC void w_thread_yield();
SWT_PUBLIC void w_thread_sleep(size_t ms);
SWT_PUBLIC size_t w_thread_get_cpu_count();
SWT_PUBLIC wbool w_thread_set_concurrency(size_t level);
