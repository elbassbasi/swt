...
SWT_PUBLIC wbool w_rect_contains(w_rect *r, int x, int y);
SWT_PUBLIC wbool w_rect_equals(w_rect *r, w_rect *rect);
...
SWT_PUBLIC wbool w_rect_intersects(w_rect *r, w_rect *rect);
SWT_PUBLIC wbool w_rect_is_empty(w_rect *r);
