...
SWT_PUBLIC wresult w_graphics_draw_polygon(w_graphics *gc, w_point *pointArray,
		int count);
SWT_PUBLIC wresult w_graphics_draw_polygonv(w_graphics *gc,int count,va_list args);
SWT_PUBLIC wresult w_graphics_draw_polyline(w_graphics *gc,
		w_point *pointArray, int count);
SWT_PUBLIC wresult w_graphics_draw_polylinev(w_graphics *gc,int count,va_list args);
...
SWT_PUBLIC wresult w_graphics_draw_text(w_graphics *gc, const char *string,
		size_t length, w_rect *rect, int flags);
...
SWT_PUBLIC wresult w_graphics_fill_polygon(w_graphics *gc, w_point *pointArray,
		int length);
SWT_PUBLIC wresult w_graphics_fill_polygonv(w_graphics *gc, int count,va_list args);
...
SWT_PUBLIC wbool w_graphics_get_advanced(w_graphics *gc);
...
SWT_PUBLIC w_line_dash* w_graphics_get_line_dash(w_graphics *gc);
...
SWT_PUBLIC wbool w_graphics_get_xor_mode(w_graphics *gc);
SWT_PUBLIC wbool w_graphics_is_clipped(w_graphics *gc);
SWT_PUBLIC wresult w_graphics_set_advanced(w_graphics *gc, wbool advanced);
...
SWT_PUBLIC wresult w_graphics_set_xor_mode(w_graphics *gc, wbool _xor);
SWT_PUBLIC wresult w_graphics_set_text_antialias(w_graphics *gc,
		int antialias);
...
SWT_PUBLIC wresult w_graphics_text_extent(w_graphics *gc, const char *string,
		int length, w_size *size, int flags);
#ifdef __cplusplus
}
#endif
