...
SWT_PUBLIC wbool w_textlayout_isok(w_textlayout *textlayout);
...
SWT_PUBLIC wbool w_textlayout_get_justify(w_textlayout *textlayout);
...
SWT_PUBLIC wresult w_textlayout_get_location(w_textlayout *textlayout,
		int offset, wbool trailing, w_point *pt, int enc);
