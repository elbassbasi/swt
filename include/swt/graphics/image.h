...
SWT_PUBLIC wbool w_image_is_ok(w_image *image);
...
SWT_PUBLIC wbool w_imageanimation_is_ok(w_imageanimation *image);
...
SWT_PUBLIC wbool w_surface_is_ok(w_surface *surface);
