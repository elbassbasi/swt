...
#ifndef SWT_CONTROLS_EXPANDBAR_H_
#define SWT_CONTROLS_EXPANDBAR_H_
...
struct _w_expanditem_class {
	...
	wbool (*get_expanded)(w_expanditem *expanditem);
	...
	wresult (*set_expanded)(w_expanditem *expanditem, wbool expanded);
...
SWT_PUBLIC wbool w_expanditem_get_expanded(w_expanditem *expanditem);
...
SWT_PUBLIC wresult w_expanditem_set_expanded(w_expanditem *expanditem, wbool expanded);
...
#endif
#endif /* SWT_CONTROLS_EXPANDBAR_H_ */
