...
struct _w_browser_class {
	...
	wbool (*get_javascript_enabled)(w_browser *browser);
	...
	wbool (*is_back_enabled)(w_browser *browser);
	wbool (*is_forward_enabled)(w_browser *browser);
	wresult (*refresh)(w_browser *browser);
	wresult (*set_javascript_enabled)(w_browser *browser, wbool enabled);
	wresult (*set_text)(w_browser *browser, const char *html, wbool trusted);
...
SWT_PUBLIC wbool w_browser_get_javascript_enabled(w_browser *browser);
...
SWT_PUBLIC wbool w_browser_is_back_enabled(w_browser *browser);
SWT_PUBLIC wbool w_browser_is_forward_enabled(w_browser *browser);
