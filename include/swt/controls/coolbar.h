...
struct _w_coolbar_class {
	...
	wbool (*get_locked)(w_coolbar *coolbar);
	wresult (*insert_item)(w_coolbar *coolbar, w_coolitem *item,int style, int index);
	wresult (*set_locked)(w_coolbar *coolbar, wbool locked);
};
/*
 *
 */
...
SWT_PUBLIC wbool w_coolbar_get_locked(w_coolbar *coolbar);
SWT_PUBLIC wresult w_coolbar_insert_item(w_coolbar *coolbar, w_coolitem *item,int style,
		int index);
SWT_PUBLIC wresult w_coolbar_set_locked(w_coolbar *coolbar, wbool locked);
/*
 *
 */
