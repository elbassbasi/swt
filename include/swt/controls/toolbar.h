...
#ifndef SWT_CONTROLS_TOOLBAR_H_
#define SWT_CONTROLS_TOOLBAR_H_
...
struct _w_toolitem_class {
	...
	wbool (*get_enabled)(w_toolitem *item);
	wbool (*get_selection)(w_toolitem *item);
	wresult (*get_tooltip_text)(w_toolitem *item,w_alloc alloc,void* user_data);
	int (*get_width)(w_toolitem *item);
	wbool (*is_enabled)(w_toolitem *item);
	wresult (*set_control)(w_toolitem *item, w_control *control);
	wresult (*set_enabled)(w_toolitem *item, wbool enabled);
	wresult (*set_image)(w_toolitem *item, int image);
	wresult (*set_selection)(w_toolitem *item, wbool selected);
...
struct _w_toolbar_class {
	...
	wbool (*get_item)(w_toolbar *toolbar, int index, w_toolitem *item);
	wbool (*get_item_from_point)(w_toolbar *toolbar, w_point *point,
			w_toolitem *item);
...
SWT_PUBLIC wbool w_toolitem_get_enabled(w_toolitem *item);
SWT_PUBLIC wbool w_toolitem_get_selection(w_toolitem *item);
...
SWT_PUBLIC wbool w_toolitem_is_enabled(w_toolitem *item);
SWT_PUBLIC wresult w_toolitem_set_control(w_toolitem *item,
		w_control *control);
SWT_PUBLIC wresult w_toolitem_set_enabled(w_toolitem *item, wbool enabled);
SWT_PUBLIC wresult w_toolitem_set_image(w_toolitem *item, int image);
SWT_PUBLIC wresult w_toolitem_set_selection(w_toolitem *item, wbool selected);
...
SWT_PUBLIC wbool w_toolbar_get_item(w_toolbar *toolbar, int index,
		w_toolitem *item);
SWT_PUBLIC wbool w_toolbar_get_item_from_point(w_toolbar *toolbar,
