...
public:
	...
	WColor Brighter() {
		...
		return WColor(w_min((int) (r / 0.7), 255),
				w_min((int) (g / 0.7), 255), w_min((int) (b / 0.7), 255),
				alpha);
	}
	 ...
	 */
	WColor Darker() {
		return WColor(w_max((int) (GetRed() * 0.7), 0),
				w_max((int) (GetGreen() * 0.7), 0),
				w_max((int) (GetBlue() * 0.7), 0), GetAlpha());
	}
};
