...
public:
	 ...
	 */
	static WToolkit* GetPlatform() {
		return (WToolkit*) w_toolkit_get_platform();
	}
	/**
	 ...
	 */
	static WToolkit* GetDefault() {
		return (WToolkit*) w_toolkit_get_default();
	}
	static bool SetDefault(WToolkit *toolkit) {
		return w_toolkit_set_default(W_TOOLKIT(toolkit)) > 0;
	}
	/**
	 ...
	 */
	bool Close() {
		return w_toolkit_close(W_TOOLKIT(this)) > 0;
	}
	/**
	 ...
	 * @see W_ICON_WORKING
	 */
	bool GetSystemImage(int id, WImage &image) {
		return w_toolkit_get_system_image(W_TOOLKIT(this), id, W_IMAGE(&image))
				> 0;
	}
	/**
    ...
    bool SetTheme(WTheme* theme) {
        return w_toolkit_set_theme(W_TOOLKIT(this), (w_theme*) theme)
               > 0;
    }
	/**
