...
wresult w_treecolumn_get_moveable(w_treecolumn *column) {
	if (W_WIDGETDATA_CHECK(column)) {
...
wresult w_treecolumn_get_resizable(w_treecolumn *column) {
	if (W_WIDGETDATA_CHECK(column)) {
...
wresult w_treecolumn_set_moveable(w_treecolumn *column, int moveable) {
	if (W_WIDGETDATA_CHECK(column)) {
...
wresult w_treecolumn_set_resizable(w_treecolumn *column, int resizable) {
	if (W_WIDGETDATA_CHECK(column)) {
...
wresult w_tree_get_header_visible(w_tree *tree) {
	if (W_WIDGET_CHECK(tree)) {
		return W_TREE_GET_CLASS(tree)->get_header_visible(tree);
	} else
		return W_FALSE;
}
wresult w_tree_get_column(w_tree *tree, int index, w_treecolumn *column) {
...
wresult w_tree_get_item(w_tree *tree, w_point *point, w_treeitem *item) {
...
wresult w_tree_get_lines_visible(w_tree *tree) {
	if (W_WIDGET_CHECK(tree)) {
		return W_TREE_GET_CLASS(tree)->get_lines_visible(tree);
	} else
		return W_FALSE;
}
wresult w_tree_get_parent_item(w_tree *tree, w_treeitem *item) {
	w_widgetdata_close(W_WIDGETDATA(item));
	if (W_WIDGET_CHECK(tree)) {
...
wresult w_tree_get_root_item(w_tree *tree, w_treeitem *root) {
...
wresult w_tree_get_sort_column(w_tree *tree, w_treecolumn *column) {
	if (W_WIDGET_CHECK(tree)) {
...
wresult w_tree_get_top_item(w_tree *tree, w_treeitem *topitem) {
...
wresult w_tree_set_insert_mark(w_tree *tree, w_treeitem *item, int before) {
	if (W_WIDGET_CHECK(tree)) {
...
wresult w_tree_set_lines_visible(w_tree *tree, int show) {
	if (W_WIDGET_CHECK(tree)) {
...
wresult w_tree_set_header_visible(w_tree *tree, int show) {
	if (W_WIDGET_CHECK(tree)) {
