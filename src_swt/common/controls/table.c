...
wresult w_table_get_header_visible(w_table *table) {
	wresult result = W_WIDGET_CHECK0(table);
	if (result > 0) {
...
wresult w_table_get_item(w_table *table, int index, w_tableitem *item) {
...
wresult w_table_get_item_from_point(w_table *table, w_point *point,
		w_tableitem *item) {
	w_widgetdata_close(W_WIDGETDATA(item));
	wresult result = W_WIDGET_CHECK0(table);
	if (result > 0) {
...
wresult w_table_get_lines_visible(w_table *table) {
	wresult result = W_WIDGET_CHECK0(table);
	if (result > 0) {
...
wresult w_table_get_sort_column(w_table *table, w_tablecolumn *column) {
	wresult result = W_WIDGET_CHECK0(table);
	if (result > 0) {
...
wresult w_table_is_selected(w_table *table, int index) {
	wresult result = W_WIDGET_CHECK0(table);
	if (result > 0) {
...
wresult w_table_set_header_visible(w_table *table, int show) {
	wresult result = W_WIDGET_CHECK0(table);
	if (result > 0) {
...
wresult w_table_set_lines_visible(w_table *table, int show) {
	wresult result = W_WIDGET_CHECK0(table);
	if (result > 0) {
...
wresult w_tablecolumn_get_moveable(w_tablecolumn *column) {
	wresult result = W_WIDGETDATA_CHECK0(column);
	if (result > 0) {
...
wresult w_tablecolumn_get_resizable(w_tablecolumn *column) {
	wresult result = W_WIDGETDATA_CHECK0(column);
	if (result > 0) {
...
wresult w_tablecolumn_set_moveable(w_tablecolumn *column, int moveable) {
	wresult result = W_WIDGETDATA_CHECK0(column);
	if (result > 0) {
...
wresult w_tablecolumn_set_resizable(w_tablecolumn *column, int resizable) {
	wresult result = W_WIDGETDATA_CHECK0(column);
	if (result > 0) {
...
wresult w_tableitem_get_checked(w_tableitem *item) {
	wresult result = W_WIDGETDATA_CHECK0(item);
	if (result > 0) {
...
wresult w_tableitem_set_checked(w_tableitem *item, int checked) {
	wresult result = W_WIDGETDATA_CHECK0(item);
	if (result > 0) {
