...
void _w_table_style(w_widget *widget, w_widget *parent, int style,
...
wresult _w_tablecolumn_set_moveable(w_tablecolumn *column, wresult moveable) {
}
wresult _w_tablecolumn_set_resizable(w_tablecolumn *column, wresult resizable) {
}
...
wresult _w_tableitem_set_checked(w_tableitem *item, wresult checked) {
}
...
wresult _w_table_set_header_visible(w_table *table, wresult show) {
}
wresult _w_table_set_lines_visible(w_table *table, wresult show) {
}
...
wresult _w_table_create(w_widget *widget, w_widget *parent, int style,
	...
	_w_table_style(widget, parent, style, &dwExStyle, &dwStyle);
	result = _w_control_create_0(W_CONTROL(widget), W_COMPOSITE(parent),
	WC_LISTVIEWA, dwExStyle, dwStyle);
	if (result > 0) {
