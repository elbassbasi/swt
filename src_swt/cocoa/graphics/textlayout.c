...
void w_textlayout_draw_border(w_textlayout *textlayout, w_graphics *gc, int x,
 ...
 int w_textlayout_get_tabs(w_textlayout *textlayout, int *tabs,
        int count){}
 wresult w_textlayout_get_text(w_textlayout *textlayout,
        w_alloc text,void* user_data){}
 ...
 wresult w_textlayout_set_alignment(w_textlayout *textlayout,
        int alignment){}
 ...
 wresult w_textlayout_set_tabs(w_textlayout *textlayout, int *tabs,
        int count){}
 wresult w_textlayout_set_text(w_textlayout *textlayout,
 ...
 wresult w_textlayout_set_wrap_indent(w_textlayout *textlayout,
        int wrapIndent){}
#endif
